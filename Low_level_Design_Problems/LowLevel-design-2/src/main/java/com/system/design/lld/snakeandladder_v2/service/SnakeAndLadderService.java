...
import com.system.design.lld.snakeandladder_v2.model.SnakeAndLadderBoard;
...
public class SnakeAndLadderService {
    ...
    private Queue<Player> queuePlayers; // Comment: Keeping players in game service as they are specific to this game and not the board. Keeping pieces in the board instead.
     ...
     * ==================Initialize board==================
     */
    public void setQueuePlayers(List<Player> queuePlayers) {
        this.queuePlayers = new LinkedList<>();
        this.initialNumberOfPlayers = queuePlayers.size();
    ...
    private boolean isGameCompleted() {
        ...
        int currentNumberOfPlayers = queuePlayers.size();
